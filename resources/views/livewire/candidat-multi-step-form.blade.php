<div>
    ...
    <form wire:submit.prevent="register">
        ...
        <div class="step-one">
            <div class="card">
                <div class="card-header bg-secondary text-white">Etape 1/4 - Personal Details</div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
        ...
        <div class="step-two">
            <div class="card">
                <div class="card-header bg-secondary text-white">Rtape 2/4 - Address & Contacts</div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
        ...
        <div class="step-three">
            <div class="card">
                <div class="card-header bg-secondary text-white">Etape 3/4 - Frameworks experience</div>
                <div class="card-body">
        ...
        <div class="step-four">
            <div class="card">
                <div class="card-header bg-secondary text-white">Etape 4/4 - Attachments</div>
                <div class="card-body">
